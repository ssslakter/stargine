...
alias triangle = List[Vertex](
    Vertex(position=Vec3(-0.5, -0.5, 0.0), color=Vec4(0.0, 0.0, 1.0, 1.0), tex_coords=Vec2(0.0, 0.0)),  # Bottom - Blue
    Vertex(position=Vec3(0.0, 0.5, 0.0), color=Vec4(1.0, 1.0, 0.0, 1.0), tex_coords=Vec2(0.5, 1.0)),  # Left - Yellow
    Vertex(position=Vec3(0.5, -0.5, 0.0), color=Vec4(1.0, 0.0, 0.0, 1.0), tex_coords=Vec2(1.0, 0.0)),  # Top - Red
)
...
fn init_buffers(vao_id: Id, vbo_id: Id, vertices: List[Vertex]):
    ...
    gl.vertex_attrib_pointer(2, 2, VertexAttribPointerType.FLOAT, False, sizeof[Vertex](), UnsafePointer[Float32]().offset(7).bitcast[NoneType]())
